...
import com.haulmont.cuba.cli.core.event.ModelRegisteredEvent
import org.kodein.di.generic.instance

/**
 * [CliContext] stores models, that are used for artifact generation.
 *
 * In common case, models are added to the context by plugins, during [com.haulmont.cuba.cli.core.event.BeforeCommandExecutionEvent],
