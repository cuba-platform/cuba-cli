...
package com.haulmont.cuba.cli.core.prompting

import com.haulmont.cuba.cli.core.bgRed
...
class Prompts internal constructor(private val questionsList: QuestionsList, kodein: Kodein = com.haulmont.cuba.cli.core.kodein) {
    ...
    companion object {
        fun create(kodein: Kodein = com.haulmont.cuba.cli.core.kodein, init: QuestionsList.() -> Unit) = Prompts(QuestionsList("", init), kodein = kodein)
    }
}
