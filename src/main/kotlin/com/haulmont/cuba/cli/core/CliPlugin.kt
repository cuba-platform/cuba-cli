 ...
 * ```
 * provides com.haulmont.cuba.cli.core.CliPlugin with `your module class`;
 * ```
 * to module-info.java.
 *
 ...
 * * [com.haulmont.cuba.cli.core.event.InitPluginEvent]
 * * [com.haulmont.cuba.cli.core.event.BeforeCommandExecutionEvent]
 * * [com.haulmont.cuba.cli.core.event.AfterCommandExecutionEvent]
 * * [com.haulmont.cuba.cli.core.event.ModelRegisteredEvent]
 * * [com.haulmont.cuba.cli.core.event.DestroyPluginEvent]
 * * [com.haulmont.cuba.cli.core.event.ErrorEvent]
 *
 ...
 *
 * All default dependencies are available throw the [com.haulmont.cuba.cli.core.kodein] instance.
 ...
 * ```
 *
 * @see com.haulmont.cuba.cli.core.cubaplugin.CubaPlugin
 */
interface CliPlugin {
