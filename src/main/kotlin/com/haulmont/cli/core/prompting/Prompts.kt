...
class Prompts internal constructor(private val questionsList: QuestionsList, kodein: Kodein = com.haulmont.cli.core.kodein) {
    ...
    companion object {
        fun create(kodein: Kodein = com.haulmont.cli.core.kodein, init: QuestionsList.() -> Unit) = Prompts(QuestionsList("", init), kodein = kodein)
    }
}
