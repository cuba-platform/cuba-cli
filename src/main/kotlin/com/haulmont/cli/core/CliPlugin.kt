 ...
 * ```
 * provides com.haulmont.cli.core.CliPlugin with `your module class`;
 * ```
 * to module-info.java.
 *
 ...
 * * [com.haulmont.cli.core.event.InitPluginEvent]
 * * [com.haulmont.cli.core.event.BeforeCommandExecutionEvent]
 * * [com.haulmont.cli.core.event.AfterCommandExecutionEvent]
 * * [com.haulmont.cli.core.event.ModelRegisteredEvent]
 * * [com.haulmont.cli.core.event.DestroyPluginEvent]
 * * [com.haulmont.cli.core.event.ErrorEvent]
 *
 ...
 *
 * All default dependencies are available throw the [com.haulmont.cli.core.kodein] instance.
 ...
 * ```
 *
 * @see com.haulmont.cuba.core.cubaplugin.CubaPlugin
 */
interface CliPlugin {
